      ...
      body: ListView.builder(
        itemBuilder: (context, position) {
          return GestureDetector(
            onTap: (){
              print(FourthScreen.links[position]);
              Navigator.push(context, MaterialPageRoute(builder: (context) => ArticleInfo(FourthScreen.topics[position],FourthScreen.articleText[position],FourthScreen.links[position])));
                      ...
                      Column(
                        ...
                        children: <Widget>[
                          ...
                          Padding(
                            ...
                            child: Text(
                              FourthScreen.preReading[position],
        ...
        itemCount: FourthScreen.topics.length,
      ),
