                      ...
                      child: FlatButton(
                        ...
                        onPressed: () async {
                          ...
                          Login()
                            ...
                            setState(() {
                              Login.newUser = value;
                              double w = double.parse(Login.newUser.weight);
                              double h = double.parse(Login.newUser.height);
                              int a = int.parse(Login.newUser.age);
                              double dailycalorieNeed;
                              bool low = false;
                              bool medium = false;
                              bool high = false;
                              Login.newUser.performance == 'low'
                                  ? low = true
                                  : Login.newUser.performance == 'medium'
                                      ? medium = true
                                      : high = true;

                              dailycalorieNeed =
                                  Login.newUser.gender.endsWith('emale')
                                      ? 655 + (9.6 * w) + (1.8 * h) - (4.7 * a)
                                      : 66 + (13.7 * w) + (5 * h) - (6.8 * a);
                              ThirdScreen.dailyCalorieNeedsWithActivity = low
                                  ? dailycalorieNeed * 1.3
                                  : medium
                                      ? dailycalorieNeed * 1.65
                                      : dailycalorieNeed * 2;
